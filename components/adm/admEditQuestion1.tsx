...
export const AdmEditQuestion1 = ({isAdd, setMode, setEditionEntity, question, setGlobalIsLoading}: IdmViewQuestion) => {
            ...
            <FormProvider {...form}>
                <form onSubmit={onSubmit} className="space-y-7 w-full max-w-max_w_question mx-auto">
                    ...
                    <div className="flex flex-col gap-2">
                        <FormLabel htmlFor="role">Question Level</FormLabel>
                        <Controller
                            name="role"
                            render={({field}) => (
